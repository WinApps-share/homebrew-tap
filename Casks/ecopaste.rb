cask "ecopaste" do
  ...
  name "EcoPaste"
  desc "Cross-platform clipboard management tool"
  ...
  zap trash: [
    "~/Library/Application Support/com.ayangweb.eco-paste",
    "~/Library/Caches/com.ayangweb.eco-paste",
    "~/Library/Logs/com.ayangweb.eco-paste",
    "~/Library/WebKit/com.ayangweb.eco-paste",
  ]
end
